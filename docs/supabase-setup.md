...
Pick the region closest to your users. Save the database password shown at creation time — you will not see it again.
Wait for the project to provision (about a minute).
2. Grab your keys
...
Paste into the editor and run. Each file prints its own status.
